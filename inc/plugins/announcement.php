...
function announcement_create($global)
{
	global $db;
	$return="";
	$query=$db->simple_select("announcement", "Announcement, Color, BackColor, Border, BorderColor, Scroll, slow_down, Css", "Global='$global' AND Enabled='1'", array("order_by"=>"Sort"));
